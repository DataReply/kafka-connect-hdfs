...
cd build_temp && \
wget https://github.com/apache/kafka/archive/trunk.zip && \
wget https://github.com/confluentinc/common/archive/v4.0.0.zip && \
wget https://github.com/confluentinc/rest-utils/archive/v4.0.0.zip && \
wget https://github.com/confluentinc/schema-registry/archive/v4.0.0.zip && \
wget https://github.com/confluentinc/kafka-connect-storage-common/archive/v4.0.0.zip && \
unzip kafka.zip && \
cd kafka-trunk && \
